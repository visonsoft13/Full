...
wget -O /etc/ssh/sshd_config https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/sshd_config
service ssh restart
...
banner_config
	...
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/sshmonitor2.sh -O /bin/sshmonitor
	chmod +x /bin/sshmonitor
    wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/badvpnsetup2.sh -O /bin/badvpnsetup
	chmod +x /bin/badvpnsetup
    wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/tcptweaker.sh -O /bin/tcptweaker
    ...
    wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/otimizar.sh -O /bin/otimizar
	chmod +x /bin/otimizar
    wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/speedtest.sh -O /bin/speedtest
	chmod +x /bin/speedtest
	wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/speedtest.py -O /bin/speedtest.py
	chmod +x /bin/speedtest.py
    wget https://raw.githubusercontent.com/visonsoft13/Full/master/scripts/detalhes.sh -O /bin/detalhes
